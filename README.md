...
CFT_Yasudis-1.0-SNAPSHOT.jar

## Сортировка
Для того, чтобы запустить сортировку необходимо в командной строке ввести команду вида:    
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`java -jar [путь к файлу CFT_Yasudis-1.0-SNAPSHOT.jar]`
Появиться пустая строка, где нужно будет ввести следующюю команду    
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`[режим сортировки:] (`[-а]-если по возрастанию `[-d]-если по убыванию) `[тип данных:] (`[-s]-если по строковое `[-i]-если целые числа) [имя входного файла] [имя выходного файла] [тип содержимого] [режим сортировки]`,  
